...
class CustomUpdater(StandardUpdater):
    ...
    def __init__(self, model, grad_clip_threshold, train_iter,
                 optimizer, device, ngpu, grad_noise=False, accum_grad=1, use_apex=False,local_rank=None):
...
def train(args):
    ...
    train_iter = {'main': ChainerDataLoader(
        dataset=train_dataset,batch_size=1,collate_fn=lambda x: x[0],sampler=train_sampler)}
